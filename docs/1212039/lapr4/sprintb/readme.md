# 1212039 - Diogo Santo - Sprint B - Self Assessment
...
**Justification and Evidences:** - There is evidence of a globally correct engineering process, although there may be small flaws in documentation or some activities with errors or missing (e.g. lack of testing) as well as small flaws in the application of good practices and techniques. There may be some inconsistency between code and design.
...
**Justification and Evidences:** - Used frequently the repository with significant messages and no failures in connection to issues/tasks. We used the task/issue management boards in an exemplary way.
