# 1212039 - Diogo Santo - Sprint A - Self Assessment
...
**Justification and Evidences:** - While the engineering process is correct, my own application of a concept was in an incorrect state. I had to rework the concept and apply it correctly.
...
**Justification and Evidences:** - Mostly significant messages.
...
**Justification and Evidences:** - Clear assignment of tasks between the group's elements. 
...
**Justification and Evidences:* - As of the end of the 1st Sprint, there's yet to be a deployment of the system to a remote virtual environment, so we can't grade it higher than this.
...
**Justification and Evidences:** - The integration is scheduled and documented.
...
**Justification and Evidences:** - All requirements have been met in full.