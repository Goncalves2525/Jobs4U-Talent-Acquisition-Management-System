...
## 5. Implementation
In the RequirementVerificationController class, I chaged the logic that is shown in the Sequence Diagram.
Instead of calling the plugin directly, I call a method that will execute the plugin in a new process.
