...
*Elaborate the Domain Model using DDD (Sprint B Analysis).*
...
**(This is the version as of the delivery of Sprint B)**

![Domain Model](/docs/Domain Model/domain_model.svg)
...
Throughout Sprint B, changes were made to the Domain Model. The final version is the one presented above.
