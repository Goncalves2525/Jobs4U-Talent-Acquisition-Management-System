...
**Justification and Evidences:** Management tools and strategies were carefully debated with all the team. It was primarily selected tools and strategies that have been used in the past with positive outcomes.
...
**Justification and Evidences:** Detailed messages for the committed development. Regular and single or minor files per commit.
...
**Justification and Evidences:** Work clearly defined between team members. There were US developed by more than on team member effectively.
...
**Justification and Evidences:* There are limited demonstration for the first sprint. Still, all that is deployed was tested and it is running.
...
**Justification and Evidences:** All integrated swiftly. No issues between components.
...
**Justification and Evidences:** All the requirements that are possible to be met in sprint a were achieved.