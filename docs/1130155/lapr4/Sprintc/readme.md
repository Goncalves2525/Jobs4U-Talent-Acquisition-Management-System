...
**Justification and Evidences:** - Globally, the team developed a consistent engineering process. All US were applied using the best practices and tested.
...
**Justification and Evidences:** - The use of issues and version control has been improving from week to week, even more when comparing to previous semesters.
...
**Justification and Evidences:* - The system has no failure in running in two or more local virtual machines.
...
**Justification and Evidences:** - All the client requirements are met. Every US is well documented and tested and solutions well known by the team.