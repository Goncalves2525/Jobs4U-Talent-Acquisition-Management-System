...
public interface job7interviewVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link job7interviewParser#header}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitHeader(job7interviewParser.HeaderContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link job7interviewParser#question10}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitQuestion10(job7interviewParser.Question10Context ctx);
}