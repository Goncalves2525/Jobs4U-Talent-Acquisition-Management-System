...
public class CandidateRequirementsGrammarValidationLexer extends Lexer {
	...
	public CandidateRequirementsGrammarValidationLexer(CharStream input) {
		super(input);
