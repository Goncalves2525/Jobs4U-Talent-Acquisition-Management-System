...
public class CandidatesBootstrapper {
    ...
    public void execute() {
        ...
        CandidateDTO cand1 = new CandidateDTO("Ana", "ana@mail.pt", "123");
        ...
        CandidateDTO cand2 = new CandidateDTO("Berta", "berta@mail.pt", "456");
        ...
        CandidateDTO cand3 = new CandidateDTO("Carlos", "carlos@mail.pt", "789");
